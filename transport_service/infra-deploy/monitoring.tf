...
module "lambda_notify_slack" {
  ...
  iam_role_arn           = data.terraform_remote_state.transport-service_generic_state.outputs.lambda_slack_notify_role_arn
  bucket_name            = data.terraform_remote_state.transport-service_generic_state.outputs.lambda_slack_notify_s3_bucket_name
  bucket_key             = data.terraform_remote_state.transport-service_generic_state.outputs.lambda_slack_notify_s3_bucket_key
  ...
  source_code_hash       = data.terraform_remote_state.transport-service_generic_state.outputs.lambda_slack_notify_binary_hash
